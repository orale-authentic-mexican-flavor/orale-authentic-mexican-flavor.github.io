...
<ul>
  ...
  <li><strong>Home delivery (WhatsApp):</strong>
  Orders received via WhatsApp and delivered from
  Apt 301, Richmond Court, Dock Road, Limerick V94 PY76.
  The customer may request food hot (reheated to ≥70°C
  before delivery) or frozen. Available during the week
  subject to stored production.</li>
</ul>
<p><strong>Production days:</strong> Fridays and Saturdays.
Each session is dedicated to one rotating menu item
(e.g. pozole one day, tamales the next), producing up
to 30 portions per session (3 freezer drawers × 10
portions per drawer). A small quantity is kept
refrigerated for immediate orders.</p>
  ...
  <tbody>
    ...
    <tr class="alt">
      ...
      <td class="celda-riesgo-alto">
        Internal temperature ≥75°C verified with
        probe thermometer (CCP1)
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <ul>
          ...
          <li>Maximum production: 30 portions
          (3 drawers × 10 portions)</li>
          <li>A small quantity is reserved
          refrigerated for immediate orders</li>
        </ul>
      </td>
    </tr>
    <tr class="alt">
      ...
      <td>
        <ul>
          ...
          <li>Internal temperature ≥75°C (CCP1)</li>
    ...
    <tr class="alt">
      ...
      <td>
        <ul>
          ...
          time of delivery</li>
          <li>Transport in an insulated bag</li>
...
<table>
  <tbody>
    ...
    <tr>
      ...
      <td>
        <ul>
          ...
          <li>Freeze immediately after rapid cooling</li>
          <li>Never freeze food that has been in the
          danger zone for more than 4 hours</li>
          <li>Maximum storage time: 3 months
          from production</li>
        </ul>
      </td>
    </tr>
    ...
    <tr>
      ...
      <td class="celda-riesgo-alto">
        <ul>
          <li>If temperature >-18°C: verify the door
          closes properly and adjust the temperature
          control</li>
          <li>If temperature >-12°C for more than
          2 hours: assess the state of the food —
          if there are signs of partial thawing,
          cook and consume immediately or discard</li>
...
<ol>
  ...
  including the backs of hands, between fingers, nails
  and wrists</li>
...
Mandatory notification to the person in charge. Mandatory
exclusion from food handling during the episode of diarrhoea
or vomiting and for 48 hours after symptoms have stopped.</p>
...
<ul>
  ...
  <li>Maximum Órale capacity: 30 portions
  (3 drawers × 10 portions)</li>
...
<ul class="checklist">
  ...
  <li><label class="checklist-item">
    <input type="checkbox" class="checklist-check">
    <span>HACCP folder with printed HACCP-01 to HACCP-11 formats</span>
  </label></li>
  <li><label class="checklist-item">
    <input type="checkbox" class="checklist-check">
  ...
  <li><label class="checklist-item">
    <input type="checkbox" class="checklist-check">
    <span>Food stored a minimum of 450mm off the ground (GN16 §4.3.10)</span>
  </label></li>
  <li><label class="checklist-item">
    <input type="checkbox" class="checklist-check">
...
<ul class="checklist">
  <li><label class="checklist-item">
    <input type="checkbox" class="checklist-check">
    <span>Portable container with tap — minimum capacity 20 litres
  — labelled "POTABLE WATER ONLY"</span>
  </label></li>
  <li><label class="checklist-item">
    <input type="checkbox" class="checklist-check">
...
food stall activities. Recommended by HSE Environmental Health Officer,
Limerick.</em></p>
`;
