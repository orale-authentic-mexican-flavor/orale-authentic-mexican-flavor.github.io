  ...
  <tbody>
    ...
    <tr class="alt">
      ...
      <td class="celda-riesgo-alto">
        ...
        esta etapa y durante el servicio (PCC1 y PCC3)
      </td>
    </tr>
...
<ul class="checklist">
  ...
  <li>
    <label class="checklist-item">
      <input type="checkbox" class="checklist-check">
      <span>Termómetro de nevera visible (lectura actual &lt;5°C)</span>
    </label>
  </li>
  <li>
    <label class="checklist-item">
  ...
  <li>
    <label class="checklist-item">
      <input type="checkbox" class="checklist-check">
      <span>Delantales limpios (mínimo 2 para rotación)</span>
    </label>
  </li>
  <li>
    <label class="checklist-item">
  ...
  <li>
    <label class="checklist-item">
      <input type="checkbox" class="checklist-check">
      <span>Vendajes impermeables de COLOR AZUL para heridas/cortes</span>
    </label>
  </li>
  <li>
    <label class="checklist-item">
  ...
  <li>
    <label class="checklist-item">
      <input type="checkbox" class="checklist-check">
      <span>Carpeta HACCP con formatos HACCP-01 a HACCP-09 impresos</span>
    </label>
  </li>
  <li>
    <label class="checklist-item">
      <input type="checkbox" class="checklist-check">
      <span>Etiquetas para fechado de productos</span>
    </label>
  </li>
  <li>
    <label class="checklist-item">
  ...
  <li>
    <label class="checklist-item">
      <input type="checkbox" class="checklist-check">
      <span>Alimentos almacenados mínimo 450mm sobre el suelo</span>
    </label>
  </li>
</ul>
...
<ul class="checklist">
  <li>
    <label class="checklist-item">
      <input type="checkbox" class="checklist-check">
      <span>Garrafón portátil con llave del agua — capacidad MÍNIMA 20 LITROS</span>
    </label>
  </li>
  <li>
    <label class="checklist-item">
      <input type="checkbox" class="checklist-check">
      <span>Garrafón etiquetado: "POTABLE WATER ONLY"</span>
    </label>
  </li>
  <li>
    <label class="checklist-item">
      <input type="checkbox" class="checklist-check">
      <span>Recipiente para agua residual — etiquetado: "WASTE WATER"</span>
    </label>
  </li>
  <li>
    <label class="checklist-item">
  ...
  <li>
    <label class="checklist-item">
      <input type="checkbox" class="checklist-check">
      <span>Sneeze screen o tapas para proteger el alimento expuesto</span>
    </label>
  </li>
  <li>
    <label class="checklist-item">
      <input type="checkbox" class="checklist-check">
      <span>Bolsas o maletines isotérmicos certificados</span>
    </label>
  </li>
  <li>
    <label class="checklist-item">
  ...
  <li>
    <label class="checklist-item">
      <input type="checkbox" class="checklist-check">
      <span>Cubeta de basura con TAPA HERMÉTICA (tight-fitting lid)</span>
    </label>
  </li>
  <li>
    <label class="checklist-item">
  ...
  <li>
    <label class="checklist-item">
      <input type="checkbox" class="checklist-check">
      <span>Copia impresa del Plan HACCP vigente (versión actual)</span>
    </label>
  </li>
  <li>
    <label class="checklist-item">
