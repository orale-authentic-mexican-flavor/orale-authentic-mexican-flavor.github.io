...
<ul class="checklist">
  ...
  <li><label class="checklist-item">
    <input type="checkbox" class="checklist-check">
    <span>Carpeta HACCP con formatos HACCP-01 a HACCP-11 impresos</span>
  </label></li>
  <li><label class="checklist-item">
    <input type="checkbox" class="checklist-check">
  ...
  <li><label class="checklist-item">
    <input type="checkbox" class="checklist-check">
    <span>Alimentos almacenados mínimo 450mm sobre el suelo (GN16 §4.3.10)</span>
  </label></li>
  <li><label class="checklist-item">
    <input type="checkbox" class="checklist-check">
